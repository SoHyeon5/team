     ...
     <div id="story-category">
          ...
          <li>주거형태</li>
        	  <li class="type=ct">
       		   	...
       		   	<option value="${boardVO.type}">${boardVO.type}</option>
          ...
          <li>평수</li>
               <li class="acreage-ct">
                   <select name = "acreage">
                        <option value="${boardVO.acreage}">${boardVO.acreage}</option>
                ...
                <li>예산</li>
                 <li class="budget-ct">
                   <select name = "budget">
                        <option value="${boardVO.budget}">${boardVO.budget}</option>
                ...
                <li class="field-ct">
                    <select name="field">
                        <option value="${boardVO.field}">${boardVO.field}</option>
                ...
                <li class="space-ct">
                   <select name = "space">
                        <option value="${boardVO.space}">${boardVO.space}</option>
...
<div class=content>
<p>내용
	<input type="text" name="contentOf" value="${boardVO.contentOf}">
</p>
</div>
</div>
	<div >
