...
<body>
	...
	<div id="home-banner-test">
		<ul>
			<a href="#" class="story-title">예산700!합리적인<br> 부분 공사로 꾸민 19년
				된 아파트
			</a>
			<li></li>
			<li><a href="#"
				class="primary-btn header-btn text-capitalize mt-10">보러가기</a></li>
		</ul>
		<!-- 배너 스와이프 -->
		<div id="visual">
			<div id="mySwipe" class='swipe'>
				<ul class="touch_banner swipe-wrap">
					<!-- 배너 목록 -->
					<li><a href="#"><img
							src="${pageContext.request.contextPath}/resources/img/ad1.png"
							width="300px" height="600px" style="border-radius: 7px;"></a></li>
					<li><a href="#"><img
							src="${pageContext.request.contextPath}/resources/img/ad2.png"
							width="300px" height="600px" style="border-radius: 7px;"></a></li>
					<li><a href="#"><img
							src="${pageContext.request.contextPath}/resources/img/ad3.png"
							width="300px" height="600px" style="border-radius: 7px;"></a></li>
				</ul>
			</div>
			<ul class="touch_bullet">
				<!-- 배너 위치 표시 -->
				<li><img
					src="${pageContext.request.contextPath}/resources/img/visual_bullet_on.png"
					width="15px" height="15px" class="active" alt="" /></li>
				<li><img
					src="${pageContext.request.contextPath}/resources/img/visual_bullet_off.png"
					width="15px" height="15px" alt="" /></li>
				<li><img
					src="${pageContext.request.contextPath}/resources/img/visual_bullet_off.png"
					width="15px" height="15px" alt="" /></li>
			</ul>
			<p class="touch_left_btn">
				<!-- 이전 버튼 -->
				<a href="#"> <img
					src="${pageContext.request.contextPath}/resources/img/visual_btn_left2.png"
					width="40px" height="40px" alt="이전 배너" />
				</a>
			</p>
			<p class="touch_right_btn">
				<!-- 다음 버튼 -->
				<a href="#"> <img
					src="${pageContext.request.contextPath}/resources/img/visual_btn_right3.png"
					width="40px" height="40px" alt="다음 배너" />
				</a>
			</p>
		</div>
	...
	<div>
		<div class="category_img">
			<div>
				<img
					src="${pageContext.request.contextPath}/resources/img/category/cat1.png"
					class="img1">
			...
			<div>
				<img
					src="${pageContext.request.contextPath}/resources/img/category/cat2.png"
					class="img2">
				<div class="category_text">
					               <h4>
					...
					<!-- 							class="inputtx" type="submit" value="평수별"> -->
					<!-- 					</form> -->
			...
			<div>
				<img
					src="${pageContext.request.contextPath}/resources/img/category/cat3.png"
					class="img3">
				<div class="category_text">
					<h4>
			...
			<div>
				<img
					src="${pageContext.request.contextPath}/resources/img/category/cat5.png"
					class="img5">
				<div class="category_text">
					<h4>
						<a href="${pageContext.request.contextPath}/interiorAsk/newInteriorAsk">빠른시공상담</a>
					</h4>
				</div>
			</div>
			<div>
				<img
					src="${pageContext.request.contextPath}/resources/img/category/cat6.png"
					class="img6">
				<div class="category_text">
					<h4>
						<a href="#">질문과답변</a>
	...
	<section class="latest-news-area section-gap">
		...
		<div class="row">
			<div class="col-lg-4 col-md-6">
				<div class="single-news card">
					<img class="card-top-img"
						src="${pageContext.request.contextPath}/resources/img/news/c1.jpg"
						width="450px" height="240px" alt="Card image cap">
					<div class="card-body">
						<h4 class="card-title">
							<a href="#"> 색감톡톡! 기분 좋은 긴장감을 주는 작업실 </a>
						</h4>
			...
			<div class="col-lg-4 col-md-6">
				<div class="single-news card">
					<img class="card-top-img"
						src="${pageContext.request.contextPath}/resources/img/news/c2.jpg"
						width="450px" height="240px" alt="Card image cap">
					<div class="card-body">
						<h4 class="card-title">
							<a href="#"> 정리를 잘못했던 신혼집,홈스타일링 후 쉬워졌어요~ </a>
						</h4>
			...
			<div class="col-lg-4 col-md-6">
				<div class="single-news card">
					<img class="card-top-img"
						src="${pageContext.request.contextPath}/resources/img/news/c3.jpg"
						width="450px" height="240px" alt="Card image cap">
					<div class="card-body">
						<h4 class="card-title">
							<a href="#"> 16번의 미팅끝에 원하는 대로 변신! </a>
						</h4>
	...
	<section class="recent-completed-project section-gap">
			...
			<div id="best_bg">
				<ul>
					<li><a href="#"><img
							...
							width="320px" height="320px" alt="" /> <span>[Special]
								베란다 유리창 창문 청소 도구! 자석창문닦이
								<p>
					...
					<li><a href="#"><img
							...
							width="320px" height="320px" alt="" /> <span>[Special]
								여름의 청량함을 담은 보에나 드 모네 시리즈 (2년 품질보증)
								<p>
					...
					<li><a href="#"><img
							...
							width="320px" height="320px" alt="" /> <span>[Special]
								샤베트 5COLOR 시어서커 선염 여름 차렵 침구세트(SS)(Q)
								<p>
		...
		<div id="showroom_zone">
			<div id="showroom">
				<ul>
					<li><a href="#"><img
							src="${pageContext.request.contextPath}/resources/img/showroom1.png"
							alt="" /> <span>365일 연중무휴 득템찬스!<strong>오늘의집 특가창고
									UP TO 90%</strong></span></a></li>
					<li><a href="#"><img
							src="${pageContext.request.contextPath}/resources/img/showroom2.png"
							alt="" /> <span>SNS에서 보던 캠핑템이 가득!<strong>감성 캠핑
									UP TO 72%</strong></span></a></li>
					<li><a href="#"><img
							src="${pageContext.request.contextPath}/resources/img/showroom3.png"
							alt="" /> <span>무더운 여름, 보기만 해도 시원한 카페트/러그<strong>SUMMER
									RUG BEST 30!</strong></span></a></li>
					<li><a href="#"><img
							src="${pageContext.request.contextPath}/resources/img/showroom4.png"
							alt="" /> <span>세라믹/대리석/원목/아일랜드식탁/주방수납장<strong>소재별
									인기식탁 모아보기 ~74%</strong></span></a></li>
					<li><a href="#"><img
							src="${pageContext.request.contextPath}/resources/img/showroom5.png"
							alt="" /> <span>나에게 맞는 향찾기<strong>캔들&디퓨저 추천가이드</strong></span></a></li>
